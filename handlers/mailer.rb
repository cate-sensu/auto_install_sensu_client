...
class Mailer < Sensu::Handler
  ...
  def handle
    ...
    smtp_address = settings[json_config]['smtp_address'] ||  'smtp.gmail.com'
    smtp_port = settings[json_config]['smtp_port'] || '587'
    smtp_domain = settings[json_config]['smtp_domain'] ||  'smtp.gmail.com'

    smtp_username = settings[json_config]['smtp_username'] || 'ohad@healthy.io'
    smtp_password = settings[json_config]['smtp_password'] || 'funnyman3434gm'
